          ...
          <>
            ...
            <div className="pt-20 w-full px-20">
              ...
              <ul className="[&>li]:flex [&>li]:items-center justify-center py-2">
                <li>
                  <TbPointFilled /> Leon Davis Coropuna
                </li>
                <li>
                  <TbPointFilled /> Avelino Lupo Condori
                </li>
                <li>
                  <TbPointFilled /> Owen Roque Soza
                </li>
                <li>
                  <TbPointFilled /> Aldo Martinez Choque
                </li>
                <li>
                  <TbPointFilled /> Gustavo Ccama Marron
                </li>
              </ul>
            </div>
          </>
